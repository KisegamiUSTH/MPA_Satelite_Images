...
% Loop to run SCA enhancement 20 times
totalStartTime = tic;  % Start overall timer
for i = 1:numRuns
    disp(['Running SCA optimization iteration: ', num2str(i)]);
...
disp('Results after 20 iterations of SCA optimization:');
