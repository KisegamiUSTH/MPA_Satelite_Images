...
% Loop for 20 runs
for i = 1:numRuns
    disp(['Running GWO optimization on GPU - Run ' num2str(i) '...']);
    
    % Measure the start time
    tic;
    
    % Apply GWO Enhancement and retrieve the best fitness
    ...
    output_file_name = ['gwo_enhanced_image_run_' num2str(i) '.jpg'];
...
title('GWO Enhanced Image (Last Run)');
